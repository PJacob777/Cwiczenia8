...
namespace Exercise6
{
    public static class LinqTasks
    {
        ...
        {
            IEnumerable<object> result = Emps.Join(Depts,e => e.Deptno, d=>d.Deptno
                ,(e,d)=>new
                {
                    e.Ename,
                    e.Job,
        ...
        {
            Emp result = Emps.Where(e=>e.Job=="Frontend programmer").First();
            return result;
        }
        ...
        public static IEnumerable<object> Task11()
        {
            IEnumerable<object> result = Emps
                ...
                .Select(e=>new
                {
                    name = Depts.First(dept => dept.Deptno==e.Key).Dname.ToUpper(),
        ...
        public static IEnumerable<Dept> Task14()
        {
            IEnumerable<Dept> result = Depts.GroupJoin(Emps,
                    dept => dept.Deptno,
                    emp => emp.Deptno,
                    (dept, emp) => new { Department = dept, EmpCount = emp.Count() })
    ...
    public static class CustomExtensionMethods
    {
        ...
        {
            return emps.Where(e => emps.Any(e2 => e2.Mgr?.Empno == e.Empno))
                .OrderBy(e => e.Ename)
